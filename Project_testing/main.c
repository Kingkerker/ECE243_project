...
volatile int *hex_display = (int*)0xFF200020;
volatile int *hex_display1 = (int*)0xFF200030;
...
int main(void)
{
    ...
    *(pixel_ctrl_ptr + 1) = (int)&Buffer1; // Set front buffer
    ...
    while (1)
    {
        ...
        // display tanks' score on hex2 and hex0
        // *hex_display = ((seven_seg_table[tank1Score] << 16) | (0b01000000 << 8) | (seven_seg_table[tank2Score]));
        displayScore(tank1Score, tank2Score);
        ...
        if(gameEnd == 0)
        {
            ...
            if(shieldExist == 1)
            {
                tank1GetShield(tank1_x, tank1_y, tank1_dir_idx, dir_x, dir_y,  shield);
                tank2GetShield(tank2_x, tank2_y, tank2_dir_idx, dir_x, dir_y,  shield);
            }
...
void displayScore(int tank1Score, int tank2Score)
{
    ...
    *hex_display = ((seven_seg_table[tank1Score] << 24) | (0b01000000 << 16) | (seven_seg_table[count2] << 8) | (seven_seg_table[tank2Score]));
    *hex_display1 = ((seven_seg_table[count1]));
