...
)
{
    ...
    if(tank1Shield == 1)
    {
        draw_tank(new1_x, new1_y, dir_x[new1_dir_idx], dir_y[new1_dir_idx], 0xFD60); // Draw tank 1
        draw_tank(new2_x, new2_y, dir_x[new2_dir_idx], dir_y[new2_dir_idx], CYAN); // Draw tank 2
    }
    else if(tank2Shield == 1)
    {
        draw_tank(new1_x, new1_y, dir_x[new1_dir_idx], dir_y[new1_dir_idx], GREEN); // Draw tank 1
        draw_tank(new2_x, new2_y, dir_x[new2_dir_idx], dir_y[new2_dir_idx], 0xFD60); // Draw tank 2
    }
    else
    {
        draw_tank(new1_x, new1_y, dir_x[new1_dir_idx], dir_y[new1_dir_idx], GREEN); // Draw tank 1
